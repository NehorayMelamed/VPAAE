...
![PICTURE OF THE FLOW DIAGRAM](/home/nehoray/PycharmProjects/Shaback/data_for_readme/window/WhatsApp Image 2023-08-17 at 01.19.27.jpeg)
...
- **Reticle image stabilization using optical flow and averaging**:
    * **Options**: 
        ...
        - Video input -> processing -> video result without averaging
          ![VIDEO](/home/nehoray/PycharmProjects/Shaback/data_for_readme/stabilization_yoav/video_stabilize.mp4)
...
1. **Averaging and stabilization - ECC** by choosing a segmentation map for an object that we want to stabilize.
    * **Options**: Directory of images + directory of segmentation mask -> processing -> image result
      ![IMAGE RESULT](/home/nehoray/PycharmProjects/Shaback/data_for_readme/ecc_classic_dudy/Screenshot from 2023-08-17 00-04-22.png)
...
2. **De-noise** - [Repository](https://github.com/xinntao/Real-ESRGAN)
    * **Options**: Video + ROI User selection -> processing -> denoised video result
      ![DEMO VIDEO](/home/nehoray/PycharmProjects/Shaback/data_for_readme/denoise/demo_video.mp4)
      ![DEMO GIF](/home/nehoray/PycharmProjects/Shaback/data_for_readme/denoise/denoise.gif)

3. **De-blur** - [Repository](https://github.com/JingyunLiang/RVRT)
    * **Options**: Video + ROI User selection -> processing -> De-blure video result
      ![GIF](/home/nehoray/PycharmProjects/Shaback/data_for_readme/deblur/teaser_vdb.gif)
      ![IMAGE](/home/nehoray/PycharmProjects/Shaback/data_for_readme/deblur/Screenshot from 2023-08-17 00-21-28.png)
      ![ANIMATION](/home/nehoray/PycharmProjects/Shaback/data_for_readme/deblur/animation4.gif)
...
4. **De-jpeg** - [Repository](https://github.com/ckkelvinchan/RealBasicVSR)
    * **Options**: Video + ROI User selection -> processing -> De-jpeg video result
      ![VIDEO](/home/nehoray/PycharmProjects/Shaback/data_for_readme/dejpeg/143370859-e0293b97-f962-476f-acf8-14fad27cea77.mp4)
...
1. **Blur kernel estimation** - [Repository](https://github.com/GuillermoCarbajal/NonUniformBlurKernelEstimation)
    * **Options**: Image + ROI User selection -> processing -> Kernel blur estimation
      ![IMAGE](/home/nehoray/PycharmProjects/Shaback/data_for_readme/kernel_blur/Corrected_Cropped_Comparison_kernels.png)
...
2. **Object segmentation based on text prompt** - [Repository](https://github.com/IDEA-Research/Grounded-Segment-Anything)
    * **Options**: Directory of images + text prompt -> processing -> segmentation map
      ![IMAGE](/home/nehoray/PycharmProjects/Shaback/data_for_readme/segmantion_sam/Screenshot from 2023-08-17 00-06-49.png)
...
3. **Object Detection & Tracking & REID - YOLO** - [Repository](https://github.com/mikel-brostrom/yolo_tracking)
    * **Options**: Video + classes and other terms -> processing -> crop and other stuff
      ![IMAGE 1](/home/nehoray/PycharmProjects/Shaback/data_for_readme/object_detection/Screenshot from 2023-08-17 00-08-18.png)
      ![IMAGE 2](/home/nehoray/PycharmProjects/Shaback/data_for_readme/object_detection/Screenshot from 2023-08-17 00-13-41.png)
...
5 **Frame Interpolation** - [Repository](https://github.com/google-research/frame-interpolation)
    * **Options**: Image a + image b -> processing -> crop and other stuff
      ![CROP IMAGE](/home/nehoray/PycharmProjects/Shaback/data_for_readme/frame_interpulation/moment.gif)
...
6. **Questions and Answering** - Based on the [Lavis Model](https://github.com/salesforce/lavis) and [ViLT Model](https://huggingface.co/dandelin/vilt-b32-finetuned-vqa)
    * **Options**: 
      ...
      - Free text question + image -> processing -> Answer
        ![IMAGE](/home/nehoray/PycharmProjects/Shaback/data_for_readme/questions_and_answering/Screenshot from 2023-08-17 00-13-08.png)
...
8. **Remove/Inpaint Any Object**
    * **Options**: 
      - Video + ROI User selection -> processing (Model) -> Inpaint object inside video, [Repository](https://github.com/geekyutao/Inpaint-Anything)
        ![VIDEO 1](/home/nehoray/PycharmProjects/Shaback/data_for_readme/remove_object/car_removed_road_from_stabilize_drone_cut.mp4)
      - Video + ROI User selection -> processing (Classic) -> Inpaint object inside video
        ![VIDEO 2](/home/nehoray/PycharmProjects/Shaback/data_for_readme/remove_object/remove_with_roi_dji_shapira.mp4)
        ![IMAGE](/home/nehoray/PycharmProjects/Shaback/data_for_readme/remove_object/Screenshot from 2023-08-17 00-20-13.png)
...
1. **Video Compression**: Compress video via H264 using YOLO Detector
    ![VIDEO Placeholder](/home/nehoray/PycharmProjects/Shaback/data_for_readme/smart_compresssion/h264_25_merged_video_0_51_25_25.mp4)
...
![WebPage](/home/nehoray/PycharmProjects/Shaback/data_for_readme/web_page/Screenshot from 2023-08-17 00-28-25.png)
...
![LICENSE PLATE IMAGE](/home/nehoray/PycharmProjects/Shaback/data_for_readme/licanse_plate_recognizer/Screenshot from 2023-08-17 00-19-18.png)
...
![window](/home/nehoray/PycharmProjects/Shaback/data_for_readme/window/Screenshot from 2023-08-17 01-04-54.png)
