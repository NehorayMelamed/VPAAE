...
directory_of_images_files = "/home/nehoray/PycharmProjects/Shaback/yolo_tracking/examples/runs/track/exp/crops/2/2"
img_files = sorted(glob.glob(join(directory_of_images_files, '*.png*')))
point_box_prompts=[]
...
print("SAM init ...")
model_type = 'vit_l'
segment_anything_hq_path = "/home/nehoray/PycharmProjects/Shaback/HQTrack/segment_anything_hq"
sam_checkpoint = os.path.join(segment_anything_hq_path, "pretrained_model", "sam_hq_vit_l.pth")
...
config = {
        ...
        'pretrain_model_path': 'result/default_InternT_MSDeAOTL_V2/YTB_DAV_VIP/ckpt/VMOS/save_step_{}.pth'.format(epoch_num),
        'gpu_id': 0,}
# set cfg
print('VMOS init ...')
